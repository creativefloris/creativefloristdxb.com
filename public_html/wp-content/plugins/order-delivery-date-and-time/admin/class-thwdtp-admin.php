...
class THWDTP_Admin {
	...
	public function admin_menu() {
		...
		$this->screen_id = add_submenu_page('woocommerce', __('Delivery Date for Woocommerce','order-delivery-date-and-time'), __(' Date and Time Scheduler','order-delivery-date-and-time'), $capability, 'th_order-delivery-date-and-time', array($this, 'output_settings'));
	}
